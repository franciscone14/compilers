...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#throwsRuleStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitThrowsRuleStatement(JavaParser.ThrowsRuleStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#exponentIndicator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExponentIndicator(JavaParser.ExponentIndicatorContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#floatTypeSuffix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFloatTypeSuffix(JavaParser.FloatTypeSuffixContext ctx);
	/**
